...
Component({
    ...
    lifetimes: {
        attached() {
            ...
            const left = (danmuData.x_position / imageData.realWidth) * imageData.pxWidth;
            const top = (danmuData.y_position / imageData.realWidth) * imageData.pxWidth + imageData.top;
            ...
            this.data._preAction = this.data.actionInfo.action;
