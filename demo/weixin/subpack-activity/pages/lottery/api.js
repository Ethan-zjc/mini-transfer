...
const postLotteryStart = ({ activity_name = "" } = {}) => {
    ...
    let noLogin = "/v1/payactivity/mini/task_lottery/start";
    let Login = "/v1/payactivity/lottery/start";
    let url = global.userId ? Login : noLogin;
    return util_request({
        url,
        method,
        host,
...
export { getHomePage, getAwardList, postAddBalance, postAssign, postLotteryStart, getSignInfo };
